...
###Code Preview
In order for this project to work you will need to have the [Ultrasonic Library](http://tutorial.cytron.com.my/2012/10/11/testing-ultrasonic-ranging-module-sn-hc-sr04/) downloaded and imported to your Arduino libraries. Instructions on adding libraries to Arduino can be found [here]() <!-- todo --> You will need 2 digital pins for an Ultrasonic sensor, they do NOT have to be PWM.
